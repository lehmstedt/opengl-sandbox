...
{
	m_world.m[0][0] = cosf(m_scale); m_world.m[0][1] = -sinf(m_scale); m_world.m[0][2] = 0.0f; m_world.m[0][3] = 0.0f;
	m_world.m[1][0] = sinf(m_scale); m_world.m[1][1] = cosf(m_scale);  m_world.m[1][2] = 0.0f; m_world.m[1][3] = 0.0f;
